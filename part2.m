...
plot(100*(out.Dg_ratio + out.Dgr_ratio), 'r--', 'LineWidth',2);
...
subplot(4,2,[5,6])
hold on;
plot(100*(out.Df_ratio + out.Dg_ratio + out.Db_ratio+ out.Dgr_ratio), 'b:', 'LineWidth',2);
plot(100*(out.Df_ratio + out.Dg_ratio), 'c', 'LineWidth',2);
plot(100*(out.Db_ratio+ out.Dgr_ratio), 'r--', 'LineWidth',2);
axis([start_year sim_time 0 100*5.5])
